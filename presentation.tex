...
\vspace{1.8cm}
\hspace{60pt}\begin{minipage}{0.78\textwidth}
  {\fontsize{28}{32}\selectfont\color{parchment}\textbf{Thank You}}
  
  \vspace{6pt}
  {\color{clay}\rule{40pt}{2.5pt}}
  
  \vspace{14pt}
  {\LARGE\color{parchment}\bfseries Questions \& Discussion}
  
  \vspace{24pt}
  {\color{parchment}\textbf{Kabeer Bora}}\\[3pt]
  {\color{parchment}University of Missouri--Kansas City}\\[3pt]
  
  \vspace{14pt}
  {\color{parchment}\textit{Comments and suggestions are welcome.}}
\end{minipage}
\end{frame}
